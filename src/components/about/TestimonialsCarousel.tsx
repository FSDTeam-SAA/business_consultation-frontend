        ...
        <div className="relative mx-auto w-full max-w-5xl">
          <div className="mb-8 flex items-center justify-between relative">
            <button
              ...
              className="text-white transition-colors hover:text-green-300 z-10"
          ...
          <div className="relative w-full h-[300px] overflow-hidden">
            <div
              className={`absolute w-full transition-all duration-600 ease-in-out ${
                isAnimating
                  ? direction === "next"
            ...
            >
              <div className="mb-12 text-center w-full max-w-3xl mx-auto">
                <p className="mb-10 px-4 text-lg md:px-16 md:text-xl">{testimonials[currentIndex].quote}</p>
                ...
                <div className="flex items-center justify-center">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-green-400">{testimonials[currentIndex].title}</p>
                  </div>
                </div>
              </div>
            </div>
